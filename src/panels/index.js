...
import getJSON from "./../custom/js/reset-json";
import addNewPage from "./../custom/js/add-new-page";
    ...
    },
    {
      ...
      buttons: [
        ...
        },
        {
          ...
          context: jsn,
          command: e => {
            e.Modal.setTitle("Components JSON")
              .setContent(getJSON(e.getComponents(), ["tagName"]))
              .open();
          },
          label: "{  }"
        },
        {
          id: addNew,
          context: addNew,
          command: e => addNewPage(e), // if req then pass the editor details
